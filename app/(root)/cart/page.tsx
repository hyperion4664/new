      ...
      <div className="grid grid-cols-1 md:grid-cols-4  md:gap-4">
        {items.length === 0 ? (
          <Card className="col-span-4 rounded-none">
            ...
            <CardContent>
              <Link href="/">Ana sayfada</Link> alışverişe devam edin
            </CardContent>
          </Card>
        ) : (
          <>
            <div className="col-span-3">
              <Card className="rounded-none">
                ...
                <CardContent className="p-4">
                  <div className="flex justify-end border-b mb-4">Fiyat</div>
                        ...
                        <div className="flex gap-2 items-center">
                          ...
                          >
                            <SelectTrigger className="w-auto">
                              <SelectValue>Adet: {item.quantity}</SelectValue>
                            </SelectTrigger>
              ...
              <Card className="rounded-none">
                <CardContent className="py-4 space-y-4">
                  {itemsPrice < FREE_SHIPPING_MIN_PRICE ? (
                    ...
                    <div className="flex-1">
                      <span className="text-green-700">
                        Siparişiniz ücretsiz kargo için uygun
                      </span>{" "}
                      Bu seçeneği ödeme sırasında seçebilirsiniz
                    </div>
                  )}

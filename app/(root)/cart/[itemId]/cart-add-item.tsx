            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
              <div className='flex justify-center items-center'>
                {itemsPrice < FREE_SHIPPING_MIN_PRICE ? (
                  ...
                  <div className='flex items-center'>
                    <div>
                      <span className='text-green-700'>
                        Siparişiniz ücretsiz kargo için uygundur.
                      </span>{' '}
                      Checkoutda bu seçeneği seçin.
                    </div>
                  </div>
                )}
              </div>
              <div className='lg:border-l lg:border-muted lg:pl-3 flex flex-col items-center gap-3  '>
                <div className='flex gap-3'>
                  <span className='text-lg font-bold'>Sepet Toplamı:</span>
                ...
                >
                  Ödemeye Git (
                  {items.reduce((a, c) => a + c.quantity, 0)} ürün)
                </Link>
                <Link
                  href='/cart'
                  className={cn(
